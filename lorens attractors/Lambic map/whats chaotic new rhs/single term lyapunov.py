# -*- coding: utf-8 -*-
"""
Created on Tue Aug 11 14:29:22 2020
...
def rhs (xi, c, A):
    T1=labeler(A, list(reversed(circle_product(xi, c, A))))
...
ax1.set_xlabel('c')
ax1.set_ylabel('x')
ax1.set_title('How Lyapunov Exponent Varies with Constant c for the a single term Lambic map ')
