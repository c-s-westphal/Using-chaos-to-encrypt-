# -*- coding: utf-8 -*-
"""
Created on Tue Aug 11 13:43:08 2020
...
for i in range(720):
    lambic_point_generator(c[i], 25)
    
ax1.set_xlabel('c')
ax1.set_ylabel('x')
ax1.set_title('How Lyapunov Exponent Varies with Constant c for the simplest Lambic Map ')
